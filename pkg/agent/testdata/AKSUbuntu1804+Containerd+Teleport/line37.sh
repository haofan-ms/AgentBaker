...
EOF
        ...
        for ADDON in https://jadarsiearchive.blob.core.windows.net/pub/ip-masq-agent-kubenet.yaml https://jiaxsongarchive.blob.core.windows.net/pub/kube-state-metrics.yaml https://jiaxsongarchive.blob.core.windows.net/pub/coredns-custom-configmap.yaml https://jiaxsongarchive.blob.core.windows.net/pub/azuredisk-csi-driver-deployment.yaml https://jiaxsongarchive.blob.core.windows.net/pub/storage-classes.yaml https://jiaxsongarchive.blob.core.windows.net/pub/kube-metrics-server.yaml; do
